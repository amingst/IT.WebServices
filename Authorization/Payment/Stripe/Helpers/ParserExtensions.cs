...
namespace IT.WebServices.Authorization.Payment.Stripe.Helpers
{
    ...
    {
        public static StripeSubscriptionRecord? ParseStripeSubscriptionRecord(this DbDataReader rdr)
        {
            var record = new StripeSubscriptionRecord()
            {
                SubscriptionID = rdr["StripeInternalSubscriptionID"] as string,
                UserID = rdr["UserID"] as string,
                StripeCustomerID = rdr["StripeCustomerID"] as string,
                StripeSubscriptionID = rdr["StripeSubscriptionID"] as string,
        ...
        public static StripePaymentRecord? ParseStripePaymentRecord(this DbDataReader rdr)
        {
            var record = new StripePaymentRecord()
            {
                PaymentID = rdr["StripeInternalPaymentID"] as string,
                SubscriptionID = rdr["StripeInternalSubscriptionID"] as string,
                UserID = rdr["UserID"] as string,
                StripePaymentID = rdr["StripePaymentID"] as string,
