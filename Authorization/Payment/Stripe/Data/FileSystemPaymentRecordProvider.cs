...
namespace IT.WebServices.Authorization.Payment.Stripe.Data
{
    public class FileSystemPaymentRecordProvider : IPaymentRecordProvider
    {
        ...
        public FileSystemPaymentRecordProvider(IOptions<AppSettings> settings)
        {
            ...
            root.Create();
            dataDir = root.CreateSubdirectory("payment").CreateSubdirectory("stripe").CreateSubdirectory("pay");
        }
        ...
        public async IAsyncEnumerable<StripePaymentRecord> GetAllBySubscriptionId(Guid userId, Guid subscriptionId)
        {
