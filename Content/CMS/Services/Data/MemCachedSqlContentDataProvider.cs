...
{
    internal class MemCachedSqlContentDataProvider : IContentDataProvider
    {
        private readonly ConcurrentDictionary<Guid, ContentRecord> cache = new();
        private readonly SqlContentDataProvider dataProvider;

        public MemCachedSqlContentDataProvider(SqlContentDataProvider dataProvider)
        {
